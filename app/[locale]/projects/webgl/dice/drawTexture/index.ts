import { MvpMatrix } from '@/app/[locale]/projects/webgl/MvpMatrix'
import { createBuffer } from '@/app/[locale]/projects/webgl/side-effects/createBuffer'
import { createElementBuffer } from '@/app/[locale]/projects/webgl/side-effects/createElementBuffer'
import { createProgram } from '@/app/[locale]/projects/webgl/side-effects/createProgram'
import { createTexture } from '@/app/[locale]/projects/webgl/side-effects/createTexture'
import { getGlContext } from '@/app/[locale]/projects/webgl/side-effects/getGlContext'
import { setAttribute } from '@/app/[locale]/projects/webgl/side-effects/setAttribute'
import { setTexture } from '@/app/[locale]/projects/webgl/side-effects/setTexture'
import { setUniform } from '@/app/[locale]/projects/webgl/side-effects/setUniform'
