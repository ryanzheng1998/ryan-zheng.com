...
export const resumeProfiles = {
  zh: {
    ...
    languageTitle: '語言能力',
    language: '中文母語；英文具備技術文件閱讀、跨國會議及工作溝通能力。',
  },
  en: {
    ...
    language:
      'Mandarin Chinese native; English with technical reading and cross-site communication ability.',
  },
}
...
export function ResumeContent({
  ...
  return (
    <main
      className={`resume-shell min-h-screen overflow-auto bg-stone-100 px-4 py-6 font-sans text-neutral-900 sm:px-6 sm:py-10 ${
        fixed ? 'resume-print-page' : ''
      }`}
    >
      {showNav && (
